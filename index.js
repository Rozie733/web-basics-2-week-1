...
const myArrowFunction = () => {
    return "I enjoy eating avocados by themselves with a pinch of salt."
};
...
console.log(stringToUpper("Man, I just love avocados."));
